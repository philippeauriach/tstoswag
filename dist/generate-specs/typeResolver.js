...
class TypeResolver {
    ...
    resolve() {
        ...
        if (ts.isMappedTypeNode(this.typeNode) && this.referencer) {
            ...
            const properties = type
                ...
                else if (mappedTypeNode.questionToken &&
        ...
        if (ts.isTypeOperatorNode(this.typeNode) && this.typeNode.operator === ts.SyntaxKind.KeyOfKeyword) {
            ...
            if (type.isUnion()) {
                const literals = type.types
                    ...
                    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                    // @ts-ignore
                    .reduce((acc, t) => [...acc, t.value.toString()], []);
        ...
        if (ts.isIndexedAccessTypeNode(this.typeNode) &&
            ...
            const isSameTypeQuery = ts.isTypeQueryNode(objectType) &&
                ts.isTypeQueryNode(indexType) &&
                objectType.exprName.getText() === indexType.exprName.getText();
            const isSameTypeReference = ts.isTypeReferenceNode(objectType) &&
    ...
    getEnumerateType(typeName) {
        ...
        if (this.hasFlag(declaredType, ts.SymbolFlags.EnumMember) &&
    ...
    getModelReference(modelType, name) {
        ...
        const deprecated = (0, jsDocUtils_1.isExistJSDocTag)(modelType, (tag) => tag.tagName.text === 'deprecated') ||
            (0, decoratorUtils_1.isDecorator)(modelType, (identifier) => identifier.text === 'Deprecated');
    ...
    getSymbolAtLocation(type) {
        ...
        return ((symbol && this.hasFlag(symbol, ts.SymbolFlags.Alias) && this.current.typeChecker.getAliasedSymbol(symbol)) ||
            symbol);
    }
    ...
    propertyFromDeclaration(propertyDeclaration, overrideToken) {
        ...
        const property = {
            ...
            deprecated: (0, jsDocUtils_1.isExistJSDocTag)(propertyDeclaration, (tag) => tag.tagName.text === 'deprecated') ||
