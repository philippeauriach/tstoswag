...
export declare function getDecoratorTypeArgs(decorator: ts.Identifier, typeChecker: ts.TypeChecker): any[];
...
export declare function getMethod(decorator: ts.Identifier, typeChecker: ts.TypeChecker): string;
