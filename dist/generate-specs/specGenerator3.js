...
const isVoidType_1 = require("./isVoidType");
const pathUtils_1 = require("./pathUtils");
const specGenerator_1 = require("./specGenerator");
const swaggerUtils_1 = require("./swaggerUtils");
class SpecGenerator3 extends specGenerator_1.SpecGenerator {
    ...
    GetSpec() {
        ...
        if (this.config.spec) {
            ...
            const mergeFuncs = {
                ...
                recursive: merge_1.recursive,
                deepmerge: (spec, merge) => (0, deepmerge_1.all)([spec, merge]),
            };
            ...
            if (res.schema && !(0, isVoidType_1.isVoidType)(res.schema)) {
                ...
                for (const p of produces) {
                    ...
                    swaggerResponses[res.name].content = {
                        ...content,
                        [p]: {
                            schema: this.getSwaggerType(res.schema, this.config.useTitleTagsForInlineObjects
    ...
    buildMediaType(controllerName, method, parameter) {
        ...
        const mediaType = {
            schema: {
                ...this.getSwaggerType(parameter.type, this.config.useTitleTagsForInlineObjects
