...
class MetadataGenerator {
    constructor(entryFile, compilerOptions, ignorePaths, controllers, rootSecurity = []) {
        ...
        this.program = controllers
            ...
            : (0, typescript_1.createProgram)([entryFile], compilerOptions || {});
        ...
        this.program.getSourceFiles().forEach((sf) => {
            ...
            (0, typescript_1.forEachChild)(sf, (node) => {
                ...
                if ((0, typescript_1.isClassDeclaration)(node) &&
                    (0, decoratorUtils_1.getDecorators)(node, (identifier) => decoratorsForController.includes(identifier.text)).length) {
